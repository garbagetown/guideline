...
| Example notifying the non-existence of the specific product in product master as system error is shown below.
 ...
 .. list-table::
   ...
   * - | (1)
     - System exception is thrown since master data that should already exist does not exist. Example of case when system error is detected in logicï¼‰
 ...
 .. list-table::
    ...
    * - 5
      ...
      - | Specify list of exception classes to rollback transactions.
        | Blank by defaultï¼ˆNot specifiedï¼‰
    * - 6
